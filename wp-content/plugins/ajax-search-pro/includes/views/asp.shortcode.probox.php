...
<div class="probox">
    ...
    <div class='proinput<?php echo w_isset_def($style['box_compact_layout'], 0)==1?' hiddend':''; ?>'>
        <form action='#' autocomplete="off">
            <input type='search' class='orig' placeholder='<?php echo asp_icl_t( "Search bar placeholder text" . " ($real_id)", w_isset_def($style['defaultsearchtext'], '') ); ?>' name='phrase' value='<?php echo apply_filters('asp_print_search_query', get_search_query()); ?>' autocomplete="off"/>
