...
<fieldset>
    ...
    <?php if ($_sfto['display_mode'] == "checkboxes"): ?>
        ...
        if ( $style['display_all_tags_check_opt'] == 1) {
            ...
            <div class="asp_option asp_option_cat asp_option_cat_level-0 asp_option_selectall">
                ...
                <div class="label"><?php echo asp_icl_t("Select all text (post_tag) " . " ($real_id)", $style['all_tags_check_opt_text']); ?></div>
    ...
    <?php elseif ($_sfto['display_mode'] == "dropdown"): ?>

        <div class="asp_select_label asp_select_single">

        <select name="post_tag_set[]">
        <?php
