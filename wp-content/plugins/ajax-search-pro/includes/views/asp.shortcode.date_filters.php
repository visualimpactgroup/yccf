...
<fieldset>
    <?php if ( $_dff['state'] != 'disabled' ): ?>
        ...
        <?php endif; ?>
        <input type="text" class="asp_datepicker" name="post_date_from" value="<?php echo $_dff_v; ?>">
    <?php endif; ?>
    ...
    <?php if ( $_dft['state'] != 'disabled' ): ?>
        ...
        <?php endif; ?>
        <input type="text" class="asp_datepicker" name="post_date_to" value="<?php echo $_dft_v; ?>">
    <?php endif; ?>
</fieldset>