...
Plugin URI: http://bit.ly/ajaxsearchpro
Description: The most powerful live search engine for WordPress.
Version: 4.9.8
Author: Ernest Marcinko
Author URI: http://bit.ly/wpdreams
*/
...
define('ASP_CURR_VER', 4948);
define('ASP_CURR_VER_STRING', "4.9.8");
 ...
 *  wd_asp()->session      => the WP_Session object (only on specific cases)
