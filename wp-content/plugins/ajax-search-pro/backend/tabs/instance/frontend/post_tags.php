...
<div class="item">
    <?php
    $o = new wpdreamsYesNo("frontend_tags_empty", "Show posts with no tags?", $sd['frontend_tags_empty']);
    ?>
    <p class="descMsg">This determines what happens to posts that have no tags if the tags selectors are active.</p>
</div>